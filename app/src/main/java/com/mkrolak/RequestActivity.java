...
public class RequestActivity extends AppCompatActivity implements OnMapReadyCallback  {
    ...
    public void onMapReady(GoogleMap googleMap) {
            mMap = googleMap;
            Marker[] markers = new Marker[]{mMap.addMarker(new MarkerOptions().position(otherPerson)),mMap.addMarker(new MarkerOptions().position(laneTech)),mMap.addMarker(new MarkerOptions().position(currentLocation))};

            markers[0].setIcon(BitmapDescriptorFactory.fromResource(R.drawable.blackcar));
            markers[1].setIcon(BitmapDescriptorFactory.fromResource(R.drawable.school));
            markers[2].setIcon(BitmapDescriptorFactory.fromResource(R.drawable.person));

            markers[2].showInfoWindow();
